...
var KPIStore = /** @class */ (() => {
	function KPIStore(dbPath) {
		...
		var defaultPath = node_path_1.default.resolve(
			__dirname,
			"../../../../..",
			"forgetm.db",
		);
		this.db = new better_sqlite3_1.default(
			dbPath || process.env.KPI_DB_PATH || defaultPath,
		);
		this.init();
	...
	KPIStore.prototype.recordEvent = function (ev) {
		...
		if (process.env.STRICT_KPI === "true") {
			try {
				...
				var ok = stmt_1.get(
					(_a = ev.guild) !== null && _a !== void 0 ? _a : null,
					ev.kpi,
					(_b = ev.goblin) !== null && _b !== void 0 ? _b : null,
				);
	...
	KPIStore.prototype.summaryFiltered = function (sinceMs, guild, goblin) {
		...
		var kpiRows = this.db
			...
			.all(
				since,
				guild !== null && guild !== void 0 ? guild : null,
				guild !== null && guild !== void 0 ? guild : null,
				goblin !== null && goblin !== void 0 ? goblin : null,
				goblin !== null && goblin !== void 0 ? goblin : null,
			);
		var toolRows = this.db
			.prepare(
	...
	KPIStore.prototype.series = function (sinceMs, params) {
		...
		var since = Date.now() - sinceMs;
		var interval =
			params.intervalMs && params.intervalMs > 0 ? params.intervalMs : 3600000;
		var rows = this.db
			.prepare(
			...
			.all(
				...
				interval,
				since,
				(_a = params.kpi) !== null && _a !== void 0 ? _a : null,
				(_b = params.kpi) !== null && _b !== void 0 ? _b : null,
				(_c = params.guild) !== null && _c !== void 0 ? _c : null,
				(_d = params.guild) !== null && _d !== void 0 ? _d : null,
				(_f = params.goblin) !== null && _f !== void 0 ? _f : null,
				(_g = params.goblin) !== null && _g !== void 0 ? _g : null,
			);
	...
	KPIStore.prototype.toolSeries = function (sinceMs, params) {
		...
		var rows = this.db
			...
			.all(
				...
				interval,
				since,
				(_a = params.tool) !== null && _a !== void 0 ? _a : null,
				(_b = params.tool) !== null && _b !== void 0 ? _b : null,
				(_c = params.guild) !== null && _c !== void 0 ? _c : null,
				(_d = params.guild) !== null && _d !== void 0 ? _d : null,
				(_f = params.goblin) !== null && _f !== void 0 ? _f : null,
				(_g = params.goblin) !== null && _g !== void 0 ? _g : null,
	...
	KPIStore.prototype.meta = function () {
		...
		var kpis = this.db
			...
			.all();
		return {
			guilds: guilds.map((g) => g.guild).filter(Boolean),
			goblins: goblins,
