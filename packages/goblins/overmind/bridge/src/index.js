			...
			switch (_a.label) {
				case 0:
					...
					if (!overmind) {
						return [
							2 /*return*/,
							res.status(500).json({ error: "Overmind not initialized" }),
						];
					}
					start = Date.now();
...
app.post("/api/memory/embeddings", (req, res) =>
	__awaiter(void 0, void 0, void 0, function () {
		var body,
			results,
			_i,
		...
		return __generator(this, (_d) => {
			switch (_d.label) {
				...
				case 1:
					...
					m = _a[_i];
					if (!m || !m.content) return [3 /*break*/, 5];
					_d.label = 2;
				case 2:
					_d.trys.push([2, 4, , 5]);
					return [
						4 /*yield*/,
						overmind.rememberFact(m.content, { tags: m.tags }),
					];
				case 3:
					id_1 = _d.sent();
					...
					if (Array.isArray(existing) && existing.length > 0) {
						match = existing.find((r) => {
							...
							return (
								String(
									r.content ||
										((_a = r.entry) === null || _a === void 0
											? void 0
											: _a.content) ||
										"",
								).trim() === String(content_1).trim()
							);
						});
						if (match) {
							existingId =
								match.id ||
								((_b = match.entry) === null || _b === void 0
									? void 0
									: _b.id) ||
								((_c = match.entry) === null || _c === void 0 ? void 0 : _c.id);
							return [
								2 /*return*/,
								res.json({ id: existingId, status: "existing" }),
							];
						}
					}
					return [3 /*break*/, 11];
				...
				case 11:
					return [
						4 /*yield*/,
						overmind.rememberFact(String(content_1), { tags: body.tags }),
					];
				case 12:
					id = _d.sent();
		...
		return __generator(this, (_b) => {
			switch (_b.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						overmind.searchMemory(String(query || ""), Number(limit) || 10),
					];
				case 1:
					results = _b.sent();
...
app.post("/forge-guild/doctor", (_req, res) =>
	__awaiter(void 0, void 0, void 0, function () {
				...
				case 0:
					...
					return [
						...
						axios_1.default.post(
							"".concat(forgeGuildUrl, "/forge-guild/doctor"),
						),
					];
				case 1:
					response = _a.sent();
...
app.post("/forge-guild/bootstrap", (_req, res) =>
	__awaiter(void 0, void 0, void 0, function () {
			...
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						axios_1.default.post(
							"".concat(forgeGuildUrl, "/forge-guild/bootstrap"),
						),
					];
				case 1:
					response = _a.sent();
...
app.post("/forge-guild/sync-config", (_req, res) =>
	__awaiter(void 0, void 0, void 0, function () {
			...
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						axios_1.default.post(
							"".concat(forgeGuildUrl, "/forge-guild/sync-config"),
						),
					];
				case 1:
					response = _a.sent();
...
app.post("/forge-guild/check", (_req, res) =>
	__awaiter(void 0, void 0, void 0, function () {
			...
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						axios_1.default.post(
							"".concat(forgeGuildUrl, "/forge-guild/check"),
						),
					];
				case 1:
					response = _a.sent();
...
app.listen(port, host, () => {
	logger.info(
		"\uD83C\uDF09 Overmind Bridge listening on ".concat(host, ":").concat(port),
	);
