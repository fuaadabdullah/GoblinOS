 ...
 */
export function initTracing(serviceName, serviceVersion = "1.0.0", otlpEndpoint = process.env.OTEL_EXPORTER_OTLP_ENDPOINT ||
...
export const tracingUtils = {
     ...
     */
    addSavingsAttributes(span, savings) {
     ...
     */
    addOllamaSelectionAttributes(span, model, taskType, volumeThreshold) {
     ...
     */
    addRoutingAttributes(span, decision) {
     ...
     */
    addHealthCheckAttributes(span, health) {
