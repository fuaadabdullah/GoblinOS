...
const schemaPath = process.env.GOBLIN_SCHEMA || path.resolve(__dirname, '../../goblins.schema.json');
const goblinsPath = process.env.GOBLINS_FILE || path.resolve(__dirname, '../../goblins.yaml');
