...
#[tauri::command]
pub async fn parse_orchestration(_mgr: tauri::State<'_, Arc<GoblinRuntimeManager>>, _text: String, _default_goblin: Option<String>) -> Result<serde_json::Value, String> {
    // TODO: implement orchestration parsing
    Ok(serde_json::json!({
        "steps": [],
        "total_batches": 1,
        "max_parallel": 1
